...
class NSeriesDbHelper private constructor(context: Context) {
    ...
    companion object {
        ...
        private var instance: NSeriesDbHelper? = null

        fun getInstance(context: Context): NSeriesDbHelper {
            if (instance == null) {
                instance = NSeriesDbHelper(context)
            }
            return instance!!
        }
    }
