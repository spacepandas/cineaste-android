...
class NMovieDbHelper private constructor(context: Context) {
    ...
    companion object {
        ...
        private var instance: NMovieDbHelper? = null

        fun getInstance(context: Context): NMovieDbHelper {
            if (instance == null) {
                instance = NMovieDbHelper(context)
            }
            return instance!!
        }
    }
