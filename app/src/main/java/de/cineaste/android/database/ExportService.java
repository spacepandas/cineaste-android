...
public class ExportService {
	...
	public static ImportExportObject export(ImportExportObject importExportObject) {
		...
		importExportObject.setEpisodesSuccessfullyImported(exportEpisodes(importExportObject.getEpisodes()));
	...
	private static boolean exportEpisodes(List<Episode> episodes) {
		return writeOnDevice(getFile(EPISODES_FILE), gson.toJson(episodes));
	}
